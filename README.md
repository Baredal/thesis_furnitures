...
data/
  ...
  w_b_runs/               W&B run artifacts for the final v3 training runs (bedrooms + living rooms)
...
| **ResNet18 fine-tuned (v3)** | **81.4 %** | **0.754** | **36.9 %** | **63.1 %** |
...
| **ResNet18 fine-tuned (v3)** | **73.0 %** | **0.635** | **14.5 %** | **50.0 %** |
...
python src/ml/build_triplets_v2.py

# 2. Train (run notebook interactively)
#    src/ml/train_v2.ipynb
